...
<div style="background-color:whitesmoke">
    <div class="container">
        <div class="row">
            <div class="inner">
                <p><span style="font-size:18px">Open source monitoring for electricity, solar, storage and heat pumps.</span></p>
...
<div class="container">
    <div class="row">
        <div class="inner">
            <br>
            <h2 style="color:#000;margin-top:14px;">Introducing the emonPi3</h2>
            ...
            <a href="https://shop.openenergymonitor.com/energy-monitoring/"> <img src="<?php echo $path; ?>pages/img/emonpi3.png" style="width:100%"></a>
            <br>
            ...
            <div style="text-align:left">
                <p>
                    ...
                    <b>emonTx6:</b> A 6 channel electricity monitoring node. Great for expanding an emonPi3 monitoring setup where more CT inputs are required either in the same location or in a different part of the building. Transmits data via 433.92MHz radio.
                </p><br>
                <p>
